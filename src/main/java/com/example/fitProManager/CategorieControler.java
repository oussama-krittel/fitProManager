...
public class CategorieControler {
    ...
    public void toAddCategorie(ActionEvent event) throws IOException {
    ...
    public void toViewCategorie(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("ViewCategorie.fxml"));
        stage=(Stage)((Node)event.getSource()).getScene().getWindow();
        scene=new Scene(root);
        stage.setScene(scene);
        stage.show();
